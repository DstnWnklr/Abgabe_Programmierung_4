...
/**
 * diese Klasse repäsentiert die Burgerpatties und erbt von der abstrakten Bestandteile-Klasse
 */

public class Pattie extends Bestandteile{
    ...
    public Pattie(Integer bildLink, String bezeichnung, double preis, String kcal, int iD) {
