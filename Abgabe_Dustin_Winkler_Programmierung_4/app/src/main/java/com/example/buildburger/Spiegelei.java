...
/**
 * diese Klasse repäsentiert das Spiegelei und erbt von der abstrakten Bestandteile-Klasse
 */

public class Spiegelei extends Bestandteile{
    ...
    public Spiegelei(Integer bildLink, String bezeichnung, double preis, String kcal, int iD) {
