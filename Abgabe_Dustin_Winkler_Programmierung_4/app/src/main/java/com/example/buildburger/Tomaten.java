...
/**
 * diese Klasse repäsentiert die Tomaten und erbt von der abstrakten Bestandteile-Klasse
 */

public class Tomaten extends Bestandteile {
    ...
    public Tomaten(Integer bildLink, String bezeichnung, double preis, String kcal, int iD) {
